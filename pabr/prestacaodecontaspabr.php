...
<?php
  ...
  if(isset($_SESSION['loginUser'])){
    ...
    $select = "SELECT * FROM permissionarios WHERE email = :filtro";
    try{
...
<div class="card card-primary" style="margin-top:10px; text-align:center;">
              <div class="card-header">
                <h5 style="text-align: center;">Prestação de Contas - Associação do Permissionários da CSB4<br> Seja bem vindo(a), <?php echo $nome; ?></h5>
            ...
            <div class="card card-primary"  style="margin-top:10px;">
              ...
              <form role="form" action="updade_permissionarios.php" method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <input  name="aptPermiss" class="form-control input-md" type="text" value="<?php echo $apt_up;?>" >
                  </div>
                  ...
                  <input id="telcel" name="telcel" class="form-control" placeholder="XX XXXXX-XXXX" required="" maxlength="15" onkeypress="return handleInput(event,this);" value="<?php echo $telcel;?>">
                  </div>
                  </div>
                  <div class="col-4">
                  ...
                  <input id="secaotrab" name="secaotrab" class="form-control" placeholder="Ex:GABAER" type="text"  onkeypress="return handleInput(event,this);" value="<?php echo $secaotrab;?>">
                  </div>
                  </div>
                  <div class="col-4">
          ...
          <div class="card card-primary">
              ...
              <form role="form" action=" " method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-4">
                  <label for="Nome">Nome</label>  
                  <input id="nomedepend" name="nomedepend" value=" " placeholder="" class="form-control input-md" required="required" type="text" onkeypress="return handleInput(event,this);">
                  </div>
              ...
              ?>
               ...
               <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo $show->datanascdepend;?></td>
                      <td>
                      <div class="btn-group">
            ...
            <!--Fim cadastro de dependentes -->
             ...
             <!-- /.inicio listar bicicletas  -->
              ...
              <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Listar Garagem <br> ( cadastrado pela administração )</h3>
              </div>
              ...
              <form role="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-4">
                  ...
                  <div class="col-4">
                    ...
                    <select name="id_permiss2" class="form-control" >
             ...
             <div class="card card-primary">
                ...
                <div class="row">
                  ...
                  <label>Tel Fixa</label>
                        <select class="form-control" name="telefonia" type="text" id="telefonia" required>
                          ...
                          <option value="NÃO USO">NÃO USO</option>
              ...
              <?php
                ...
                if(isset($_POST['botao3'])) {
                      ...
                      $cadastro = "UPDATE servicos SET telefonia =:telefonia,internet=:internet,tv_coletiva=:tv_coletiva,arquivo=:arquivo,atualizado=:atualizado WHERE id_permiss = '$id_permiss'";
