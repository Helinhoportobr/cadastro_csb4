...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Prestação de Contas CSB4</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      if(isset($_POST['login'])){
        ...
        $select = "SELECT * FROM usuarios WHERE email_user=:emailLogin AND senha_user=:senhaLogin AND ativo_user='S'";
        ...
        try{
          ...
          if($verificar>0){
            ...
            header("location: prestacaodecontaspabr.php");
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalLabel" style="color:blue;">Atenção</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Clique em "Registrar novo usuário", e utilize o email de cadastro na Administração: pabrcontabilidade@gmail.com, e crie uma senha.
      </div>
