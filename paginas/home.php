...
include_once('../includes/header.php');
    if(isset($_GET['acao'])){
        ...
        $acao = $_GET['acao'];
         ...
         }elseif($acao == 'relatorio_recadastramento'){
            include_once('../paginas/conteudo/relatorio_recadastramento.php');
         }elseif($acao == 'editar_usuarios'){
            include_once('../paginas/conteudo/editar_usuarios.php');
         }elseif($acao == 'update_usuarios'){
            include_once('../paginas/conteudo/update_usuarios.php');
         }elseif($acao == 'delet_usuarios'){
            include_once('../paginas/method/delet_usuario.php');
         }elseif($acao == 'cadastro_usuarios'){
            include_once('../paginas/conteudo/cadastro_usuarios.php');
         }elseif($acao == 'relatorio_servicos'){
            include_once('../paginas/conteudo/relatorio_servicos.php');
         }
    }else{
        include_once('../paginas/conteudo/dashboard.php');
    }
