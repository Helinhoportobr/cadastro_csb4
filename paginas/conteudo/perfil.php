          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="senha" id="senha" required value="<?php echo base64_decode($senha_user); ?>">
                  </div>
              ...
              <?php
                ...
                $update = "UPDATE usuarios SET foto_user=:foto,nome_user=:nome,email_user=:email,senha_user=:senha WHERE id_user=:id";
                try{
            ...
            <div class="card">
              ...
              <div class="card-body p-0" style="text-align: center; margin-bottom: 98px">
                <img src="../dist/img/usuarios/<?php echo $foto_user; ?>" alt="<?php echo $foto_user; ?>" title="<?php echo $foto_user; ?>" style="width: 200px; border-radius: 100%; margin-top: 30px">
