...
<?php
  ...
  $select = "SELECT * FROM garagem_troca INNER JOIN permissionarios ON permissionarios.id_permissionarios = garagem_troca.cod_permiss WHERE garagem_troca.arquivo = 'Nao' AND garagem_troca.id_garagem_troca = $id";
          ...
          <div class="col-md-12">
            ...
            <div class="card-body">
              <form role="form" action=" " method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-6">
                  <label for="postoesp">Permissionário</label>
                  <select name="id_permiss" class="form-control">
                  <?php 
                      
                      
                        $result_permissioanario = "SELECT * FROM garagem_troca INNER JOIN permissionarios ON permissionarios.id_permissionarios = garagem_troca.cod_permiss WHERE permissionarios.arquivo = 'Nao' AND id_garagem_troca = $id";
                  ...
                  <div class="col-4">
                  <label for="Nome">Ult Desist</label>  
                  <input id="datault" name="datault" class="form-control input-md"  type="date" value="<?php echo $ulti_desist; ?>">
                  </div>
                ...
                if(isset($_POST['upcontato'])) {
                 ...
                 // echo $dataentr;
                  ...
                  //echo $ulti_desist;
                      ...
                      $update = "UPDATE garagem_troca SET cod_permiss=:id_permiss,dataentr_troca_gar=:dataentr,data_ulti_desist=:datault,qnd_desist=:qnddesit WHERE id_garagem_troca = $id";
                    ...
                    try{
                      ...
                      if($contar > 0){
                          ...
                          echo '<div class="container">
                                ...
                                header("Refresh: 2, ?acao=cadastro_fila_troca");
                          }else{
                            echo '<div class="container">
                                 ...
                                 header("Refresh: 2, ?acao=cadastro_fila_troca&id=$id");
