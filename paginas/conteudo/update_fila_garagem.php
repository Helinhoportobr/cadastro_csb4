  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Atualizar fila de Espera carro</h1>
          </div>
  ...
  $select = "SELECT * FROM garagem_espera WHERE id_garagem_espera = :id";
  ...
  try{
    ...
    if($contar>0){
      ...
      while($show = $resultado->FETCH(PDO::FETCH_OBJ)){
          ...
          $id_garagem_espera = $show->id_garagem_espera;
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Atualizar Fila carro</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-4">
                    ...
                    <?php
                    $select = "SELECT * FROM garagem_espera INNER JOIN permissionarios ON permissionarios.id_permissionarios = garagem_espera.id_permiss WHERE garagem_espera.arquivo = 'Nao' AND `id_garagem_espera` = $id";
                    try{
              ...
              <?php
                ...
                if(isset($_POST['botao'])) {
                  ...
                  //echo $arquivo;
                        ...
                        $cadastro = "UPDATE garagem_espera SET dataentr_pred=:dataentr, prioridade=:prioridade  WHERE id_garagem_espera = $id";
                        ...
                        try{
                          ...
                          if($contar > 0){
                            echo '<div class="container">
                                ...
                                header("Refresh: 1, ?acao=editar_fila_garagem&id=$id");
                          }else{
                            echo '<div class="container">
                                  ...
                                  header("Refresh: 1, ?acao=cadastro_veiculo");
                          }
                        }catch (PDOException $e){
                          echo "<strong>ERRO DE PDO= </strong>".$e->getMessage();
                        }
