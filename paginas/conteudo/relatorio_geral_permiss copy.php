...
<?php
 ...
 $select = "SELECT * FROM permissionarios INNER JOIN usuarios ON usuarios.email_user = permissionarios.email WHERE permissionarios.arquivo = 'Nao' AND permissionarios.id_permissionarios = :id";
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="../dist/img/usuarios/<?php echo $foto_user; ?>" alt="<?php echo $foto_user; ?>" title="<?php echo $foto_user; ?>"
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#notificacao" data-toggle="tab">Notificações</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                ...
                <h3><b> Notificações </b></h3>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $show->data_registro;?></td>
                      <td><?php echo $id_doc;?></td>
                      
                      <td>
                        
                      <div class="height-100 d-flex justify-content-center align-items-center">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-toggle="modal" data-target="#exampleModalCenter" > Upload </button> <!-- Modal -->
                      </div>
                      ...
                      <td>
                        <!-- Modal -->
                      <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-id=. $id_doc  aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Download Notificação</h5>
                    ...
                    <!-- /.card-header -->
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="submit" name="botao_notifi" class="btn btn-primary">Upload</button>
                          </form>
                          <?php
                                  include('../config/conexao.php');
                                  if(isset($_POST['botao_notifi'])) {
                                    ...
                                    if(in_array($extensao, $formatP)){
                                      ...
                                      if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                          $cadastro = "UPDATE documentos_notificacao SET arquivo_pdf=:foto WHERE id_documentos_not = $id_doc and id_permiss  = $id";
