    ...
    <section class="content-header">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title">Relatório Motos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                    <?php
                      ...
                      $select = "SELECT * FROM garagem_moto WHERE `arquivo` = 'Nao' ORDER BY `vaga` + 0 ASC";
                    ...
                    <tr>
                      ...
                      <div class="btn-group">
                        ...
                        <a href="method/delet_garagem_moto.php?idDel=<?php echo $show->id_garagem_moto;?>&vaga=<?php echo $show->vaga;?>" onclick="return confirm('Deseja remover da Fila')" class="btn btn-danger" title="Remover Bicicleta"><i class="fas fa-user-times"></i></a>
                      </div>
                      </td>
                    </tr>
                    <?php
