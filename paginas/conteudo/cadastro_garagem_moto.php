          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Cadastrar na Fila</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  $sql = "SELECT `posicao_fila` FROM `garagem_espera_motos` ORDER BY`id_garagem_espera_moto` DESC limit 1";
              ...
              <?php
                ...
                if(isset($_POST['botao'])) {
                  ...
                  //echo $arquivo;
                        ...
                        $cadastro = "INSERT INTO garagem_espera_motos (id_permiss,dataentr_pred,arquivo,posicao_fila) VALUES (:id_permiss,:dataentr,:arquivo,:posicao)";
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Fila de espera motos</h3>
              </div>
              <!-- /.card-header -->
                ...
                <thead>
                  ...
                  <tbody>
                    <?php
                      ...
                      $select = "SELECT * FROM garagem_espera_motos INNER JOIN permissionarios ON permissionarios.id_permissionarios = garagem_espera_motos.id_permiss WHERE garagem_espera_motos.arquivo = 'Nao'";
                    ...
                    <tr>
                      ...
                      <td>
                      <div class="btn-group">
                        <a href="home.php?acao=update_fila_garagem_motos&id=<?php echo $show->id_garagem_espera_moto;?>" class="btn btn-success" title="Editar"><i class="fas fa-user-edit"></i></button>
                        <a href="home.php?acao=delet_fila_espera_motos&idDel=<?php echo $show->id_garagem_espera_moto;?>" onclick="return confirm('Deseja remover da Fila')" class="btn btn-danger" title="Remover da Fila"><i class="fas fa-user-times"></i></a>
                      </div>
                      </td>
                    </tr>
                    <?php
