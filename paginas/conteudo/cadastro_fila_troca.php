            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  $sql = "SELECT `posicao_fila` FROM `garagem_troca` ORDER BY`id_garagem_troca` DESC limit 1";
              ...
              <?php
                ...
                if(isset($_POST['botao'])) {
                  ...
                  //echo $arquivo;
                        ...
                        $cadastro = "INSERT INTO garagem_troca (cod_permiss,dataentr_troca_gar,arquivo,posicao_fila) VALUES (:id_permiss,:dataentr,:arquivo,:posicao)";
                ...
                <thead>
                  ...
                  <tbody>
                    <?php
                      ...
                      $select = "SELECT * FROM garagem_troca INNER JOIN permissionarios ON permissionarios.id_permissionarios = garagem_troca.cod_permiss WHERE garagem_troca.arquivo = 'Nao'";
                    ...
                    <tr>
                      ...
                      <td>
                      <div class="btn-group">
                        <a href="home.php?acao=editar_fila_troca&id=<?php echo $show->id_garagem_troca;?>" class="btn btn-success" title="Editar"><i class="fas fa-user-edit"></i></button>
                        <a href="method/delet_fila_troca.php?idDel=<?php echo $show->id_garagem_troca;?>" onclick="return confirm('Deseja remover da Fila')" class="btn btn-danger" title="Remover da Fila"><i class="fas fa-user-times"></i></a>
                      </div>
                      </td>
                    </tr>
                    <?php
