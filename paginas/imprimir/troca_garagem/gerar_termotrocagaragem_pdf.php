...
$sql = "SELECT * FROM `permissionarios` INNER JOIN garagem ON garagem.id_permiss = permissionarios.id_permissionarios WHERE garagem.id_permiss = '$idPermutanteA' AND permissionarios.arquivo = 'Nao'";
...
$sql = "SELECT * FROM `permissionarios` INNER JOIN garagem ON garagem.id_permiss = permissionarios.id_permissionarios WHERE garagem.id_permiss = '$idPermutanteB' AND permissionarios.arquivo = 'Nao'";
