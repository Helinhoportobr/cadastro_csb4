    ...
    <section class="content-header">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title">Relatório Cautela de Material</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                    <?php
                      ...
                      $select = "SELECT * FROM `documentos_cautela` WHERE `arquivo_doc` = 'Nao' ORDER BY `data_saida_doc` + 0 DESC";
                    ...
                    <tr>
                      ...
                      <td><?php if (!empty($show->data_entrega_doc && $show->data_entrega_doc != '0000-00-00')) 
                        {
                                $dob = date_format(date_create($show->data_entrega_doc), "d-m-Y");
                        } else {
                                $dob = '';
                        }?></td>
                      ...
                      <td>
                      <div class="btn-group">
                      <a href="home.php?acao=recebe_objeto_cautelado&idDoc=<?php echo $show->id_documentos;?>&user=<?php echo $nome_user; echo '- '; echo $cargo;  ?>" onclick="return confirm('Deseja realmente confirmar o recebimento do objeto')" class="btn btn-success" title="Receber Objetos"><i class="fa fa-check-square" aria-hidden="true"></i></a>
                      <a href="home.php?acao=delet_cautela_material&idDel=<?php echo $show->id_documentos;?>" onclick="return confirm('Deseja remover a Cautela')" class="btn btn-danger" title="Remover Cautela"><i class="fa fa-trash"></i></a>
                      </div>
                      </td>
                    </tr>
                    <?php
