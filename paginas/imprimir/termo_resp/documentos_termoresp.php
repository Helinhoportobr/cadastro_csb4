             ...
             <div class="card">
              ...
              <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Pesquisar..">
                <table class="table table-striped" id="myTable" >
                  ...
                  <tbody>
                    <?php
                    $select = "SELECT * FROM `permissionarios` WHERE `arquivo` = 'Nao' ORDER BY `id_permissionarios` DESC";
                    try{
                    ...
                    <tr>
                      ...
                      <td>
                      <div class="btn-group">
                      <a href="home.php?acao=gerar_termoresp&id=<?php echo $show->id_permissionarios;?>" class="btn btn-primary" title="Editar Permissionário"><i class="fas fa-edit"></i></a>
