...
<div class="login-box">
  <div class="login-logo">
    <a href="cad_user.php" style="font-size: 25px"><b>Administração</b> - CSB4</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="ativo" class="form-control" value='N'>
                ...
                if(isset($_POST['botao'])) {
                  ...
                  if(in_array($extensao, $formatP)){
                    ...
                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                        $cadastro = "INSERT INTO usuarios (foto_user,nome_user,email_user,senha_user,cargo_user,ativo_user) VALUES (:foto,:nome,:email,:senha,:cargo,:ativo)";
