...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Administração</b> - CSB4</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      if(isset($_POST['login'])){
        ...
        $select = "SELECT * FROM usuarios WHERE email_user=:emailLogin AND senha_user=:senhaLogin AND ativo_user='Sim' AND cargo_user !='Permissionario'";
